...
public class RestaurantTest {
     ...
     public void restaurant_instantiates_true() {
       Restaurant myRestaurant = new Restaurant("PokPok",1,"503-443-2432");
       assertTrue(myRestaurant instanceof Restaurant);
     }

     @Test
     public void restaurant_returnsParametersValue_name() {
       Restaurant testRestaurant = new Restaurant("PokPok",1,"503-443-2432");
     ...
     public void all_returnsAllValues() {
       Restaurant testRestaurant = new Restaurant("PokPok",9,"503-443-2432");
       testRestaurant.save();
     ...
     public void equals_returnsTrueIfSameName_true() {
       Restaurant testRestaurant = new Restaurant("KoiFusion",9,"503-718-7990");
       testRestaurant.save();
       Restaurant nextRestaurant = new Restaurant("KoiFusion",9,"503-718-7990");
       nextRestaurant.save();
     ...
     public void equals_returnsFalseIfDifferentName_false() {
       Restaurant testRestaurant = new Restaurant("KoiFusion",9,"503-718-7990");
       testRestaurant.save();
       Restaurant nextRestaurant = new Restaurant("Nicolas Food",8,"503-721-1680");
       nextRestaurant.save();
     ...
     public void save_assignsNameToObject() {
       Restaurant testRestaurant = new Restaurant("PokPok",8,"503-443-2432");
       testRestaurant.save();
       Restaurant savedRestaurant = Restaurant.first();
     ...
     public void find_findsRestaurantInDatabase() {
       Restaurant testRestaurant = new Restaurant("PokPok",7,"503-443-2432");
       testRestaurant.save();
